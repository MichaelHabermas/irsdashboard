// Mock synthetic tax-return data. 100% synthetic — matches the project's
// privacy posture. Used by all three design directions.

window.IRS_DATA = (function () {
  const cases = [
    {
      id: 'TR-2024-04812',
      ...
      explanations: [
        {
          ...
          quote: 'You can deduct ordinary and necessary expenses for carrying on a trade or business — but only to the extent they are reasonable in amount and not lavish.',
        },
        {
          ...
          quote: 'If your total deduction for all noncash contributions is over $500, you must complete Form 8283 and attach it to your return.',
        },
        {
  ...
  // Distribution histogram (score buckets, 0.0..1.0 in 10 bins)
  const scoreHistogram = [310, 220, 168, 124, 96, 78, 64, 52, 40, 28];

  // Time-series (last 14 days, flagged count per day)
  const flaggedTrend = [22, 18, 24, 31, 28, 19, 22, 26, 33, 29, 24, 31, 38, 38];

  return { cases, queueStats, scoreHistogram, flaggedTrend };
})();
