...
|------|-------|--------|--------|
| 1 | Project Setup & Monorepo Infrastructure | Not Started | 0 / 4 |
...
- Zero application code yet — `/backend` and `/frontend` contain only Dockerfiles + nginx config.
- Ready to begin **Epic 1.1.1** (root pnpm workspace + TS + ESLint + Prettier + Husky).
